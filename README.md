...
Let's try the Monte Carlo method to train an IA to play.
You will be able to see that because of the large number of possible state. The model doesn't work very well even after 500 000 simulated episodes.
